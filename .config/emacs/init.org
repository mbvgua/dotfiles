...
** Transparency
With Emacs version 29, true transparency has been added, but Ifind this distracting, so Id rather not have it.
...
#     (projectile-project-search-path '("~/Desktop/projects/" "~/.dotfiles/")))
# #+end_src
