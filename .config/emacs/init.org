...
#+begin_src emacs-lisp
  ...
  (use-package general
    ...
    (start/leader-keys
      ...
      ;; magit
      "m" '(:ignore t :wk "magit")
      "m s" '(magit-status :wk "[m]agit [s]tatus")
      "m d" '(magit-diff-buffer-file :wk "current [m]agit file [d]iff")
      ...
      "c n" '(flymake-goto-next-error :wk "flymake [n]ext error")
      "c p" '(flymake-goto-prev-error :wk "flymake [p]revious error")
      ))
...
#+begin_src emacs-lisp
  ...
  ;; (evil-define-key 'normal 'global (kbd "gd") 'xref-find-definitions) ;; Goto definitions
...
#+begin_src emacs-lisp
  ...
  (mason-setup
    (dolist (pkg '("clangd" "cpptools" "bash-language-server" "pyright" "lua-language-server"
                   "jdtls" "json-lsp" "yaml-language-server" "typescript-language-server"
                   "docker-compose-language-service"
  				 ;; formatter
                   "black" "ruff" "stylua" "prettier"))
